...
config_name = 'ref-adapted-search-translator-hmax-general-util'
config_date = '19-05-16'
...
exp.add_algorithm('ref-adapted-search-hmax-cb-opt', REPO, REV, ["--search", "astar(hmax(transform=osp_utility_to_cost(), use_cost_bound=true))"])
