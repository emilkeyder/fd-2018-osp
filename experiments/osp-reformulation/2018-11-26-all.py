...
config_name = 'osp-reformulation-search-blind-general-util'
config_date = '18-11-26'
...
exp.add_algorithm('ref-search-blind', REPO, REV, ["--search", "astar(blind())"])
...
exp.add_fetcher('data/2018-11-26-blind-eval')
exp.add_fetcher('data/2018-11-26-lmcut-eval')
exp.add_fetcher('data/2018-11-26-hmax-eval')
