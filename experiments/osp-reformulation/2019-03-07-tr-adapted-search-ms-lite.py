...
config_name = 'ref-adapted-search-translator-ms-lite-general-util'
config_date = '19-03-07'
...
#exp.add_algorithm('ref-adapted-search-ms-lite-cb', REPO, REV, ['--heuristic', "ms=merge_and_shrink(shrink_strategy=shrink_by_h(),merge_strategy=merge_linear(random_seed=-1, update_option=use_first,variable_order=GOAL_CG_LEVEL),max_states=50000,threshold_before_merge=1,transform=osp_utility_to_cost(), use_cost_bound=true)", '--search', "astar(ms)"])

exp.add_algorithm('ref-adapted-search-ms-lite-cb', REPO, REV, ['--heuristic', "ms=merge_and_shrink(shrink_strategy=shrink_by_h(),merge_strategy=merge_precomputed(merge_tree=linear(random_seed=-1, update_option=use_first,variable_order=GOAL_CG_LEVEL)),max_states=50000,threshold_before_merge=1,transform=osp_utility_to_cost(), use_cost_bound=true)", '--search', "astar(ms)"])
