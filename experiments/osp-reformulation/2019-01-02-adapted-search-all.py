...
config_name = 'osp-reformulation-adapted-search-general-util-all'
config_date = '19-01-02'
...
exp.add_algorithm('ref-adapted-search-lmcut', REPO, REV, ["--search", "astar(lmcut(transform=osp_utility_to_cost()))"])
...
exp.add_fetcher('data/2018-12-28-adapted-search-blind-eval')
exp.add_fetcher('data/2018-12-28-adapted-search-hmax-eval')
exp.add_fetcher('data/2018-12-28-adapted-search-lmcut-eval')
