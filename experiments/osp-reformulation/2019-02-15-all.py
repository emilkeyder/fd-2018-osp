...
config_name = 'adapted-search-all-general-util'
...
exp.add_fetcher('data/2019-02-15-adapted-search-hmax-eval')
exp.add_fetcher('data/2019-02-15-ms-bound-adapted-eval')
exp.add_fetcher('data/2019-02-15-ms-nobound-adapted-eval')
exp.add_fetcher('/storage/US1J6721/lab/examples/osp/data/2019-01-04-blind_osp-eval')
