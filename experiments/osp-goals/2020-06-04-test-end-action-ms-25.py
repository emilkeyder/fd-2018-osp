...
exp.add_fetcher('/storage/US1J6721/experiments/fd-2018-osp-keyder/experiments/osp-reformulation/data/2019-10-17-tr-adapted-search-ms-600-eval')
...
def filter_domains(run):
    return run['domain'].endswith("25")

# Make a report.
exp.add_report(
    AbsoluteReport(attributes=ATTRIBUTES, filter_algorithm=['ref-adapted-search-ms-lr-cb-600', 'ms-cb-600-ga'], filter=filter_domains),
