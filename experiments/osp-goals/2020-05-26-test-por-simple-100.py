...
exp.add_algorithm('hmax-cb-sss', REPO, REV, ["--search", "astar(hmax(transform=osp_utility_to_cost(), use_cost_bound=true), pruning=stubborn_sets_simple(min_required_pruning_ratio=0.0, expansions_before_checking_pruning_ratio=1000))"])
...
ATTRIBUTES = ['coverage', 'expansions', 'evaluations', 'expansions_until_last_jump', 'reopened', 'search_time', 'total_time', 'util_initial_state', 'util_upper_bound', 'plan_util', 'initial_h_value', 'por_before', 'por_after', 'por_diff']
