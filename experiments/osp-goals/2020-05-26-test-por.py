...
REPO = get_repo_base()
BENCHMARKS_DIR = '/homes/hny1/US1J6721/software/ospbenchmarks05072020'

domains = ['airport', 'barman-opt11-strips', 'barman-opt14-strips', 
'blocks', 'childsnack-opt14-strips', 'depot', 'driverlog', 
 'elevators-opt08-strips', 'elevators-opt11-strips', 'floortile-opt11-strips', 'floortile-opt14-strips', 
 'freecell', 'ged-opt14-strips', 'grid', 'gripper', 'hiking-opt14-strips', 'logistics00', 'logistics98', 
 'miconic', 'movie', 'mprime', 
 # 'mystery', 
 'nomystery-opt11-strips', 'openstacks-opt08-strips', 'openstacks-opt11-strips', 
 'openstacks-opt14-strips', 'openstacks-strips', 'parcprinter-08-strips', 'parcprinter-opt11-strips', 
 'parking-opt11-strips', 'parking-opt14-strips', 'pathways-noneg', 'pegsol-08-strips', 
 'pegsol-opt11-strips', 'pipesworld-notankage', 
 'pipesworld-tankage', 'psr-small', 
 'rovers', 'satellite'
 , 'scanalyzer-08-strips', 
 'scanalyzer-opt11-strips', 'sokoban-opt08-strips', 'sokoban-opt11-strips', 
 'storage', 'tetris-opt14-strips', 'tidybot-opt11-strips', 
 ...
 'agricola-opt18-strips', 'data-network-opt18-strips', 
 # 'organic-synthesis-opt18-strips', 
 'organic-synthesis-split-opt18-strips', 
 'petri-net-alignment-opt18-strips', 'snake-opt18-strips', 
 'spider-opt18-strips', 'termes-opt18-strips'
]


bounds = ['100', '125', '150', '175', '200']
...
config_name = 'test-pruning'
config_date = '2020-05-26'
...
exp.add_algorithm('hmax-cb-por', REPO, REV, ["--search", "astar(hmax(transform=osp_utility_to_cost(), use_cost_bound=true), pruning=stubborn_sets_simple(min_required_pruning_ratio=0.0, expansions_before_checking_pruning_ratio=1000))"])
...
exp.add_fetcher('data/2019-02-16-tr-adapted-search-ms-eval')
