...
config_name = 'test-benchmarks'
config_date = '2020-05-15'
...
exp.add_algorithm('hmax-cb', REPO, REV, ["--search", "astar(hmax(transform=osp_utility_to_cost(), use_cost_bound=true))"])
