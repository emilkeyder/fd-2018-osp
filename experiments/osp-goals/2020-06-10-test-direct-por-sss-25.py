...
config_name = 'test-direct-reform-search-sss'
config_date = '2020-06-10'
...
REV='564993fd04a2686fdb43f9e3c67bbc5c689d619e'

exp.add_algorithm('hmax-cb-sss-direct', REPO, REV, ["--search", "astar(hmax(use_cost_bound=true), pruning=stubborn_sets_simple(min_required_pruning_ratio=0.0, expansions_before_checking_pruning_ratio=1000))"])
...
exp.add_fetcher('data/2020-06-10-test-direct-25-eval')
...
algs=['hmax-cb', 'hmax-cb-direct', 'hmax-cb-sss-direct']
algs=['hmax-cb-direct', 'hmax-cb-sss-direct']


# Make a report.
exp.add_report(
    AbsoluteReport(attributes=ATTRIBUTES, filter_algorithm=algs),
